...
<head>
	...
	<link rel="stylesheet" href="jquery.fs.tipper.css">
...
<body>
	...
	<div class="container">
		<h3>demo</h3>
		<button class="btn btn-default" title="thanks...">click me</button> 
	</div>
		...
		$(document).ready(function(){
			$('button').tipper({
				...
				formatter: function($target) {
					return "<small>TITLE:</small><br /><strong>" + $target.attr("title") + "</strong>";
				}
			});
		});
	</script>
